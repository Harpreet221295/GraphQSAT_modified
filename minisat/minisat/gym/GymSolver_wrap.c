...
extern "C" {
#endif
SWIGINTERN int Swig_var_Minisat_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_namespace,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""Minisat""' of type '""namespace""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""Minisat""' of type '""namespace""'");
    } else {
      Minisat = *((namespace *)(argp));
    }
  }
  return 0;
fail:
...
SWIGINTERN PyObject *Swig_var_Minisat_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&Minisat), SWIGTYPE_p_namespace,  0 );
  return pyobj;
}
...
# endif
  ...
  SWIG_addvarlink(SWIG_globals(),(char *)"Minisat",Swig_var_Minisat_get, Swig_var_Minisat_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
